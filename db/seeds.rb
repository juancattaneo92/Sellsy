...
prod1 = Product.create(title:'Handmade Rustic mug', category:'Home&Living Art&Collectibles Gifts Art&Collectibles Gifts', description:'These rustic mugs are hand-thrown on the wheel by me. Each one is unique but similar enough to make a nice set.', price:'26.00')
prod2 = Product.create(title:'Anti fog face mask, with filter pocket', category:'Jewelry&Accessories Clothing&Shoes Gifts', description:'Face Mask with filter pocket and nose wire. One size fits most adults and youth. May suit for some adults', price:'10.00')
prod3 = Product.create(title:'Handmade VEGAN Replacement Apple Watch Strap', category:'Jewelry&Accessories Gifts', description:'Handpicked Ethnic patters and premium craftsmanship are used for the make of every band, proving you with a better, higher quality strap you deserve', price:'30.00')
prod4 = Product.create(title:'Landscape art, modern picture, set of three', category:'Home&Living Art&Collectibles Gifts', description:'Comes in a set of three, this prints works well on their own but also with other prints which can be found in the series.', price:'50.00')
prod5 = Product.create(title:'Table lamp-Desk, lamp-Rustic home decor-Gift', category:'Home&Living Art&Collectibles Gifts', description:'Handcrafted by a small team of experienced craftsman in the USA with great attention to detail, using the highest quality materials and parts', price:'40.00')
prod6 = Product.create(title:'Bohemian colorful Rug multi colors', category:'Home&Living Art&Collectibles Gifts', description:'Amazing lamp', price:'100.00')
prod7 = Product.create(title:'Sterling Silver Earrings Set', category:'Jewelry&Accessories Gifts', description:'Gold-filled jewelry is jewelry composed of a solid layer of gold (typically constituting at least 5% of the items total weight)', price:'15.00')
prod8 = Product.create(title:'Bartender Kit - Barware for Bartending', category:'Home&Living Toys&Entertainment CraftSupplies Gifts', description:'The BarStash bartending kit is the perfect bartender kit for any home. Our 17 piece set provides tools organized perfectly in a stylish bamboo stand.', price:'80.00')
prod9 = Product.create(title:'Knit Scarf, Chunky Scarf', category:'Jewelry&Accessories Clothing&Shoes Gifts', description:'An oversize chunky infinity scarf—a staple accessory you need for any chilly day. So cozy and soft, made of premium Italian wool knit fabric.', price:'60.00')
prod10 = Product.create(title:'Handcrafted Garden Tool Gift Set', category:'Home&Living Art&Collectibles Gifts', description:'Hand Forged Gardening Tool Gift Set By Fisher Blacksmithing from Bozeman Montana', price:'120.00')
prod11 = Product.create(title:'Perfect Autumn Day Scented Beeswax Candles in Amber Glass', category:'Home&Living Gifts', description:'Each candle is made with 100% pure beeswax, no added coloring, a cotton wick and just the necessary fragrance oil.', price:'10.00')
prod12 = Product.create(title:'Triangle Hanging Shelf', category:'Home&Living Gifts', description:'This is the miniature version of the Hanging Triangle Shelf, (which is listed below if you are looking for a larger size).', price:'25.00')
prod13 = Product.create(title:'Colorful And Unique Polymer Clay Figurine', category:'Home&Living Wedding&Party Toys&Entertainment Art&Collectibles Gifts', description:'This colorful Handmade indoor sculpture made with polymer clay', price:'35.00')
prod14 = Product.create(title:'Mens Wallet, Minimalist Wallet, Personalized Wallet', category:'Jewelry&Accessories Art&Collectibles Gifts', description:'Mens Wallet, Minimalist Wallet, Personalized Wallet, Mens Wallet, Minimalist Wallet Men, Slim Wallet, Personalized Wallet Men, Engraved', price:'30.00')
prod15 = Product.create(title:'Brown Womens Bag, Leather Shoulder Bag,', category:'Jewelry&Accessories Gifts', description:'Since 2003 Floto leather bags have been produced by hand using old world craft methods and modern technology. Artisan made in Tuscany, Italy.', price:'120.00')
prod16 = Product.create(title:'Mr. and Mrs. Mug Set', category:'Home&Living Wedding&Party Gifts', description:'These personalized Mr. and Mrs. Mugs are a great gift idea for an engagement, bridal shower, wedding or even an anniversary.', price:'15.00')
prod17 = Product.create(title:'Personalized Premium Leather Journal Notebook or Sketchbook', category:'Jewelry&Accessories Art&Collectibles Gifts', description:'You can get your leather journal with OR without engraved initials, name, or date!', price:'35.00')
prod18 = Product.create(title:'Acrylic Paint Bottles. Fluid Acrylic Primary Set ', category:'Toys&Entertainment Art&Collectibles CraftSupplies Gifts', description:' Perfect for painting on canvas, wood boards, papers, and other types of surfaces.', price:'10.00')
prod19 = Product.create(title:'Blackout Circle Clock, Monochrome Modern Décor', category:'Home&Living Gifts', description:'Blackout Circle Clock from Metal Art Studio. Less is more with this sleek and stylish modern wall clock, featuring a flawless black finish', price:'80.00')
prod20 = Product.create(title:'Custom Letter Bracelet', category:'Jewelry&Accessories Wedding&Party Gifts', description:'Personalized Handmade Silver Jewelry handcrafted with love.', price:'25.00')
