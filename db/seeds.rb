...
prod1 = Product.create(title:'Handmade Rustic mug', description:'These rustic mugs are hand-thrown on the wheel by me. Each one is unique but similar enough to make a nice set.', price:'26.00', cart_id:'1')
prod2 = Product.create(title:'Anti fog face mask, with filter pocket', description:'Face Mask with filter pocket and nose wire. One size fits most adults and youth. May suit for some adults', price:'10.00', cart_id:'2')
prod3 = Product.create(title:'Handmade VEGAN Replacement Apple Watch Strap', description:'Handpicked Ethnic patters and premium craftsmanship are used for the make of every band, proving you with a better, higher quality strap you deserve', price:'30.00', cart_id:'3')
prod4 = Product.create(title:'Landscape art, modern picture, set of three', description:'Comes in a set of three, this prints works well on their own but also with other prints which can be found in the series.', price:'50.00', cart_id:'4')
prod5 = Product.create(title:'Table lamp-Desk, lamp-Rustic home decor-Gift', description:'Handcrafted by a small team of experienced craftsman in the USA with great attention to detail, using the highest quality materials and parts', price:'40.00', cart_id:'5')
prod6 = Product.create(title:'Bohemian colorful Rug multi colors', description:'Amazing lamp', price:'100.00', cart_id:'6')
prod7 = Product.create(title:'Sterling Silver Earrings Set', description:'Gold-filled jewelry is jewelry composed of a solid layer of gold (typically constituting at least 5% of the items total weight)', price:'15.00', cart_id:'7')
prod8 = Product.create(title:'Bartender Kit - Barware for Bartending', description:'The BarStash bartending kit is the perfect bartender kit for any home. Our 17 piece set provides tools organized perfectly in a stylish bamboo stand.', price:'80.00', cart_id:'8')
prod9 = Product.create(title:'Knit Scarf, Chunky Scarf', description:'An oversize chunky infinity scarf—a staple accessory you need for any chilly day. So cozy and soft, made of premium Italian wool knit fabric.', price:'60.00', cart_id:'9')
prod10 = Product.create(title:'Handcrafted Garden Tool Gift Set', description:'Hand Forged Gardening Tool Gift Set By Fisher Blacksmithing from Bozeman Montana', price:'120.00', cart_id:'10')
prod11 = Product.create(title:'Perfect Autumn Day Scented Beeswax Candles in Amber Glass', description:'Each candle is made with 100% pure beeswax, no added coloring, a cotton wick and just the necessary fragrance oil.', price:'10.00', cart_id:'11')
prod12 = Product.create(title:'Triangle Hanging Shelf', description:'This is the miniature version of the Hanging Triangle Shelf, (which is listed below if you are looking for a larger size).', price:'25.00', cart_id:'12')
prod13 = Product.create(title:'Colorful And Unique Polymer Clay Figurine', description:'This colorful Handmade indoor sculpture made with polymer clay', price:'35.00', cart_id:'13')
prod14 = Product.create(title:'Mens Wallet, Minimalist Wallet, Personalized Wallet', description:'Mens Wallet, Minimalist Wallet, Personalized Wallet, Mens Wallet, Minimalist Wallet Men, Slim Wallet, Personalized Wallet Men, Engraved', price:'30.00', cart_id:'14')
prod15 = Product.create(title:'Brown Womens Bag, Leather Shoulder Bag,', description:'Since 2003 Floto leather bags have been produced by hand using old world craft methods and modern technology. Artisan made in Tuscany, Italy.', price:'120.00', cart_id:'15')
prod16 = Product.create(title:'Mr. and Mrs. Mug Set', description:'These personalized Mr. and Mrs. Mugs are a great gift idea for an engagement, bridal shower, wedding or even an anniversary.', price:'15.00', cart_id:'16')
prod17 = Product.create(title:'Personalized Premium Leather Journal Notebook or Sketchbook', description:'You can get your leather journal with OR without engraved initials, name, or date!', price:'35.00', cart_id:'17')
prod18 = Product.create(title:'Acrylic Paint Bottles. Fluid Acrylic Primary Set ', description:' Perfect for painting on canvas, wood boards, papers, and other types of surfaces.', price:'10.00', cart_id:'18')
prod19 = Product.create(title:'Blackout Circle Clock, Monochrome Modern Décor', description:'Blackout Circle Clock from Metal Art Studio. Less is more with this sleek and stylish modern wall clock, featuring a flawless black finish', price:'80.00', cart_id:'19')
